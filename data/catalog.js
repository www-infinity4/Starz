...
window.HERMIT_CATALOG = [
  { id:"STZ-001", title:"The Seeds", year:2024, collection:"Supernatural Thriller", runtimeSeconds:6758, videoId:"-KP8vE35DkU", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  ...
  { id:"STZ-003", title:"Deadly Obsession 2", year:2026, collection:"Suspense Premiere", runtimeSeconds:5094, videoId:"46E8wrlfeus", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  ...
  { id:"STZ-007", title:"Fright", year:2024, collection:"After-Dark Horror", runtimeSeconds:4847, videoId:"XvdxnvOsy4U", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  ...
  { id:"STZ-010", title:"Deadly Obsession", year:2024, collection:"Thriller Premiere", runtimeSeconds:5645, videoId:"fGs8GqQbuyI", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  { id:"STZ-011", title:"Feet of Death", year:2024, collection:"Creature Feature", runtimeSeconds:6391, videoId:"jJ8ZLaJmpmQ", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  { id:"STZ-012", title:"The Whip", year:2024, collection:"Modern Heist", runtimeSeconds:4912, videoId:"vboUAIibXPo", source:"Indie Rights", networkChannel:"Starz", cleared:true },
  ...
  { id:"STZ-014", title:"Unraveled", year:2025, collection:"Love and Revenge", runtimeSeconds:4924, videoId:"wfMT-N2pqQA", source:"Indie Rights", networkChannel:"Starz", cleared:true }
